...
public class CourseSchedule2_dfs_with_stack {
    /**
    ...
    public int[] findOrder(int numCourses, int[][] prerequisites) {
        ...
        Arrays.fill(color, 'W');
        Deque<Integer> result = new ArrayDeque<>(numCourses);
    ...
    public boolean dfs(int vertex, char[] color, Deque<Integer> result,Map<Integer, List<Integer>> adjList){
        color[vertex] = 'G';
        boolean noCycle = true;
