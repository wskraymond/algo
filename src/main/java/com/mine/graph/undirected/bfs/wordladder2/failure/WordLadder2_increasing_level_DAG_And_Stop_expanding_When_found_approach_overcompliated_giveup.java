...
public class WordLadder2_increasing_level_DAG_And_Stop_expanding_When_found_approach_overcompliated_giveup {
    /**
    ...
    public List<List<String>> findLadders(String beginWord, String endWord, List<String> wordList) {
        ...
        */
        ...
        /*
            stop increasing level and linking edges to end word only
            when end word is found.

            => too complicated to do so when simplifying undirected to DAG
         */
        while(!q.isEmpty()){
            level++;
            int n = q.size();
